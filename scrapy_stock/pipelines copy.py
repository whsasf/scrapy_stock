...
class Prepare(object):
    ...
    def change_mongo_status(s1,s2):
        ...
        try:
            ...
            collection.update_many({"status_flag": status1},{"$set":{"status_flag": status2}})
        finally:
            db_client.close()
...
class MongoDBPipeline(object):
    ...
    def close_spider(self,spider):
        ...
        Prepare.change_mongo_status(2,1)
    ...
    def insert_db(self,item):
        item['status_flag'] = 2 # middle status
