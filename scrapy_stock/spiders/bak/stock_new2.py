...
""".format(long_loading_wait_time,short_loading_wait_time,short_loading_wait_time,short_loading_wait_time,middle_loading_wait_time,short_loading_wait_time,short_loading_wait_time)
    ...
    def parse(self, response):
        ...
        if stock_area == 'HK':
            ...
            for group in group_list:
                ...
                stock_id = group[2]
                #print(group)
                yield SplashRequest(real_url,endpoint = 'execute',args = {'lua_source':lua_extract_page ,'images': 0,'timeout': rendering_page_timeout},callback=self.extract_page,dont_filter=False,meta={'stock_name':stock_name,'stock_id':stock_id,'stock_area':stock_area})
        elif stock_area == 'US':
